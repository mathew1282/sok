    ...
    <div id="templateModal" class="modal-overlay" style="display:none;">
        <div class="modal">
            ...
            <div class="tag-buttons">
                ...
                <button type="button" class="btn-primary" onclick="insertTag('@wot')">@wot</button>
                <button type="button" class="btn-primary" onclick="insertTag('@policjant')">@policjant</button>
